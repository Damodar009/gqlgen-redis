...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreatUser  func(childComplexity int, input model.CreateUserInput) int
...
type MutationResolver interface {
	CreatUser(ctx context.Context, input model.CreateUserInput) (*model.User, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.creatUser":
		...
		return e.complexity.Mutation.CreatUser(childComplexity, args["input"].(model.CreateUserInput)), true
...
func (ec *executionContext) field_Mutation_creatUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	arg0, err := ec.field_Mutation_creatUser_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_creatUser_argsInput(
	ctx context.Context,
	rawArgs map[string]interface{},
) (model.CreateUserInput, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateUserInput2gqlgenᚑtodosᚋgraphᚋmodelᚐCreateUserInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateUser_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNUpdateUserInput2gqlgenᚑtodosᚋgraphᚋmodelᚐUpdateUserInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_creatUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreatUser(rctx, fc.Args["input"].(model.CreateUserInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_deleteUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDeleteUserResponse2ᚖgqlgenᚑtodosᚋgraphᚋmodelᚐDeleteUserResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputCreateUserInput(ctx context.Context, obj interface{}) (model.CreateUserInput, error) {
	...
	fieldsInOrder := [...]string{"name", "age", "gender", "email", "phone"}
...
func (ec *executionContext) unmarshalNCreateUserInput2gqlgenᚑtodosᚋgraphᚋmodelᚐCreateUserInput(ctx context.Context, v interface{}) (model.CreateUserInput, error) {
	res, err := ec.unmarshalInputCreateUserInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteUserResponse2gqlgenᚑtodosᚋgraphᚋmodelᚐDeleteUserResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteUserResponse) graphql.Marshaler {
	return ec._DeleteUserResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteUserResponse2ᚖgqlgenᚑtodosᚋgraphᚋmodelᚐDeleteUserResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteUserResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateUserInput2gqlgenᚑtodosᚋgraphᚋmodelᚐUpdateUserInput(ctx context.Context, v interface{}) (model.UpdateUserInput, error) {
